...
def run(NUM_SEMENTS, NUM_SECONDS, NUM_BATCH, LEADS, NUM_EPOCHS, DATA_PATH, FS):
    ...
    full_dataset = ECGDataset(DATA_PATH, PATIENT_IDS, FS, NUM_SEMENTS, NUM_SECONDS, LEADS)

    labels = []
    for patient_id in PATIENT_IDS:
        labels.extend([patient_id] * NUM_SEMENTS)
